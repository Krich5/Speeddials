(() => {
                ...
                e.exports = function(e) {
                    ...
                    e.exports = function(e) {
                        ...
                        n.r(t), n.d(t, "BrowserNotification", (function() {
                            ...
                            return D
                        })), n.d(t, "clearInterval", (function() {
                            return q
                        })), n.d(t, "clearTimeout", (function() {
                            return U
                        })), n.d(t, "setInterval", (function() {
                            return F
                        })), n.d(t, "setTimeout", (function() {
                            return z
                        }));
                        var i = n(0),
                            r = n.n(i),
                        ...
                        class s {
                            ...
                            maskObjectProperty(e) {
                                ...
                                Object.keys(e).forEach((n => {
                                    "object" == typeof e[n] && null !== e[n] ? this.maskObjectProperty(e[n]) : t[n] = "*********"
                                }))
                            }
                            maskLogData(e) {
                                Object.keys(e).forEach((t => {
                                    "object" == typeof e[t] && null !== e[t] ? this.maskKeys[t] ? this.maskObjectProperty(e[t]) : this.maskLogData(e[t]) : (this.maskKeys[t] && "string" == typeof e[t] || "value" === t && this.maskKeys[e.name]) && (e[t] = "*********")
                                }))
                            }
                            maskPIIInformation(e) {
                                const t = e[e.length - 1],
                                    n = "string" == typeof t ? this.tryJSONParse(t) : this.copiedObj(t);
                                n && "object" == typeof n && (this.maskLogData(n), e.splice(e.length - 1, 1, n))
                            }
                        }
                        const a = (...e) => e.map((e => "string" == typeof e ? e : JSON.stringify(e)));
                        var u;

                        function c(e, t) {
                            const n = new u.Service(e, t);
                            return u.POOL.addLogger(n), n
                        }! function(e) {
                            ...
                            ! function(e) {
                                ...
                                constructor(e, t) {
                                    this.loggerEmitter = r()(), this.prefix = e, this.maskKeys = t
                                }
                                log(t, ...n) {
                                    this.maskKeys && "object" == typeof this.maskKeys && ((e, t) => {
                                        new s(t).maskPIIInformation(e)
                                    })(n, this.maskKeys);
                                    const i = a(this.prefix ? ["" + this.prefix, ...n] : n),
                                        r = Date.now(),
                                        u = o.DateTime.fromMillis(r).toFormat("yyyy-LL-dd HH:mm:ss:SSS");
                                    switch (t) {
                                        case e.Level.Trace:
                                            console.info(u, ...i);
                                            break;
                            ...
                            class i {
                                ...
                                static getLogsReadableText(e) {
                                    const t = e => e.reduce(((e, t) => {
                                        ...
                                        return n && (e += n.timestamp + " " + n.prefix + " " + n.level + " " + a(n.messages).join(" ") + " \r\n"), e
                                    }), "");
                        ...
                        const l = c("unified-ui-platform-sdk");
                        var d, h;

                        function f(e) {
                            return new d.Service(e)
                        }
                            ...
                            class t {
                                ...
                                requestNotificationUserPermission() {
                                    return function(e, t, n, i) {
                                        ...
                                        this.isBrowserNotificationSupported ? t.isBrowserNotificationPromiseSupported ? yield window.Notification.requestPermission(): yield new Promise((e => window.Notification.requestPermission((t => e(t))))): l.warn("Browser notification is not supported...")
                                    }))
                                }
                                fire(e, t) {
                        ...
                        (m = g || (g = {})).Debounce = function(e = 250) {
                            ...
                            return (e, t) => {
                                const n = {
                                    get() {
                                        return new y(this, void 0 !== t ? t : e.key)
                                    },
                                    enumerable: !0,
                                    configurable: !0
                                };
                                    ...
                                    return v(this, void 0, void 0, (function*() {
                                        const o = this,
                                            s = t => v(this, void 0, void 0, (function*() {
                                                t.id && "string" == typeof t.id && "yes" === t.isErr || ("string" == typeof t || t instanceof Error ? t = new h.Message("system", t) : (console.warn("Err must be 'string' or 'new Error()' instance"), t = new h.Message("system", "")));
                                                const i = t;
                                                i.ctx = o;
                        ...
                        var k, x, C = n(5),
                            ...
                            I = n(7),
                            A = n.n(I);
                        (x = k || (k = {})).createService = e => {
                            const t = O.a.createInstance();
                            {
                                const n = e && e.backend ? e.backend : new T.a;
                                t.use(n)
                            } {
                                const n = e && e.languageDetector ? e.languageDetector : new A.a;
                                t.use(n)
                            }
                        ...
                        }, x.mergeServiceInitOptions = (...e) => Object.assign.call(null, {}, ...e), x.createMixin = e => {
                            const t = "i18n" in e ? e.i18n : x.createService(),
                                n = "i18nInitOptions" in e ? e.i18nInitOptions : null;
                            n || l.info("i18n mixin instance waiting service initialization outside...");
                            let i = !1;
                        ...
                        function _(e = {}) {
                            ...
                            e.Item = class {
                                ...
                                deactivate(e) {
                                    this._status && t.StatusWeight[this._status] < t.StatusWeight[t.Status.Deactivated] ? this._serviceHubAdapter ? this._serviceHubAdapter.emit("statusServiceUpdateRequest", this, t.Status.Deactivated, e) : l.warn("Service hub adapter is not initialized for this notification item instance: ", this) : l.warn(`Notification should have "${t.Status.Pended}" or "${t.Status.Activated}" status to be able change status to "${t.Status.Deactivated}".Current notification status is "${this._status}". Ignoring this change`)
                                }
                                pending() {
                            ...
                            class u {
                                ...
                                prepareAddNotifications(t) {
                                    ...
                                    return (Array.isArray(t) ? t : [t]).filter((e => !this.serviceConfig.DISABLED_ITEM_MODE[e.data.mode] || (l.error(`Trying to .add(...) notification mode "${e.data.mode}" that is disabled in this notifications service instance by configuration.Current configuration is: "${JSON.stringify(this.config)}"Only ${n} allowed. Ignoring .add(${JSON.stringify(e)}) notification...`), !1))).map((t => new e.Item(t, this.serviceHubAdapter)))
                                }
                                prepareUpdateNotifications(e) {
                                    return (Array.isArray(e) ? e : [e]).reduce(((e, t) => (t.timestamp in this.map ? e.push(t) : l.error("Trying to handle untracked notification. Call .add(...) first...", JSON.stringify(t)), e)), [])
                                }
                                ...
                                static validateUpdateConfig(e) {
                                    ...
                                    if (i.DISABLED_ITEM_MODE) {
                                        ...
                                        Object.keys(i.ACTIVATED_ITEM_MODE_LIMIT).forEach((e => {
                                            e in i.DISABLED_ITEM_MODE && i.DISABLED_ITEM_MODE[e] && l.warn(`Changing configuration limit count for mode "${e}" won't have any effect, because this mode is disabled in notifications service instance`)
                                        })), "AUTO_DISMISS_TIMEOUT" in i && i.DISABLED_ITEM_MODE[t.Mode.AutoDismiss] && l.warn(`Changing "AUTO_DISMISS_TIMEOUT" configuration option won't have any effect,because "${t.Mode.AutoDismiss}" mode is disabled in notifications service instance`)
                                    }
                                    return !0
                                }
                                updateConfig(e) {
                                    u.validateUpdateConfig(e) && (this.serviceConfig = u.mergeConfig({}, this.serviceConfig, e), l.info("Updated notifications service configuration: ", this.config))
                                }
                                add(e) {
                            ...
                            V = () => {
                                ...
                                return l.info("Worker url established", t), j = (e => {
                                    const t = new Map([
                                        ...
                                        i = new Map,
                                        r = new Worker(e);
                                    l.info("worker created ", r);
                                    const o = new WeakMap;
                                    var s;
                                    const a = ((e, t) => n => {
                                        const i = t.get(n);
                                        let r = void 0 === i ? n.size : i < 1073741824 ? i + 1 : 0;
                                        if (!n.has(r)) return e(n, r);
                                        if (n.size < 536870912) {
                                            for (; n.has(r);) r = Math.floor(1073741824 * Math.random());
                                            return e(n, r)
                                        }
                                        if (n.size > P) throw new Error("Congratulations, you created a collection of unique numbers which uses all available integers!");
                                        for (; n.has(r);) r = Math.floor(Math.random() * P);
                                        return e(n, r)
                                    })((s = o, (e, t) => (s.set(e, t), t)), o);
                                    return r.addEventListener("message", (({
                                        data: e
                                    }) => {
                                        if (void 0 !== (r = e).method && "call" === r.method) {
                                            const {
                                                params: {
                                                    timerId: r,
                                                    timerType: o
                                            ...
                                            if ("interval" === o) {
                                                ...
                                                if ("number" == typeof e) {
                                                    const t = i.get(e);
                                                    if (void 0 === t || t.timerId !== r || t.timerType !== o) throw new Error("The timer is in an undefined state.")
                                                } else {
                                        ...
                                        } else if ((e => null === e.error && "number" == typeof e.id)(e)) {
                                            const {
                                                id: r
                                            } = e, o = i.get(r);
                                            ...
                                            i.delete(r), "interval" === a ? t.delete(s) : n.delete(s)
                                        } else {
                                            const {
                                                error: {
                                                    message: t
                                        ...
                                        setInterval: (e, n) => {
                                            const i = a(t);
                                            return t.set(i, (() => {
                                                e(), "function" == typeof t.get(i) && r.postMessage({
                                                    id: null,
                                                    method: "set",
                                                    params: {
                                                        delay: n,
                                        ...
                                        setTimeout: (e, t) => {
                                            const i = a(n);
                                            return n.set(i, e), r.postMessage({
                                                id: null,
                                                method: "set",
                                                params: {
                                                    delay: t,
                                ...
                                })(t), j.setTimeout((() => URL.revokeObjectURL(t)), 0), j
                            },
                            q = e => V().clearInterval(e),
                            U = e => V().clearTimeout(e),
                            F = (e, t) => V().setInterval(e, t),
                            z = (e, t) => V().setTimeout(e, t)
                    }])
                }, function(e, t, n) {
                    "use strict";
                    var i = n(13),
                    ...
                    function r(e, t) {
                        for (var n = 0; n < t.length; n++) {
                            var r = t[n];
                            r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(e, Object(i.a)(r.key), r)
                        }
                    }
                    ...
                    r = function(e, t) {
                        ...
                        return d(t), r = this, i.call(this, e, n = function() {
                            o.call(r, e, n), h.call(t, this, arguments)
                        }), n.__eeOnceListener__ = t, this
                    }, a = {
                        on: i = function(e, t) {
                            var n;
                            return d(t), v.call(this, "__ee__") ? n = this.__ee__ : (n = y.value = p(null), g(this, "__ee__", y), y.value = null), n[e] ? "object" == typeof n[e] ? n[e].push(t) : n[e] = [n[e], t] : n[e] = t, this
                        },
                        once: r,
                        off: o = function(e, t) {
                            var n, i, r, o;
                        ...
                        emit: s = function(e) {
                            ...
                            if (v.call(this, "__ee__") && (r = this.__ee__[e]))
                                if ("object" == typeof r) {
                                    ...
                                    for (r = r.slice(), t = 0; i = r[t]; ++t) h.call(i, this, o)
                        ...
                        off: l(o),
                        emit: l(s)
                    }, c = m({}, u), e.exports = t = function(e) {
                        return null == e ? p(c) : m(Object(e), u)
                    }, t.methods = a
                }, function(e, t, n) {
                    "use strict";
                    var i = n(34)();
                    ...
                    (function(t) {
                        ...
                        var u, c = {
                            ...
                            adapter: (("undefined" != typeof XMLHttpRequest || void 0 !== t && "[object process]" === Object.prototype.toString.call(t)) && (u = n(16)), u),
                    ...
                    e.exports = function(e) {
                        return new Promise((function(t, n) {
                            ...
                            if (p.open(e.method.toUpperCase(), s(v, e.params, e.paramsSerializer), !0), p.timeout = e.timeout, "onloadend" in p ? p.onloadend = y : p.onreadystatechange = function() {
                            ...
                            "setRequestHeader" in p && i.forEach(h, (function(e, t) {
                                void 0 === d && "content-type" === t.toLowerCase() ? delete h[t] : p.setRequestHeader(t, e)
                            })), i.isUndefined(e.withCredentials) || (p.withCredentials = !!e.withCredentials), f && "json" !== f && (p.responseType = e.responseType), "function" == typeof e.onDownloadProgress && p.addEventListener("progress", e.onDownloadProgress), "function" == typeof e.onUploadProgress && p.upload && p.upload.addEventListener("progress", e.onUploadProgress), e.cancelToken && e.cancelToken.promise.then((function(e) {
                    ...
                    (function(e) {
                        ...
                        t.a = function(e, t, n, a) {
                            return "function" == typeof n && (a = n, n = void 0), a = a || function() {}, i ? function(e, t, n, i) {
                                e.queryStringParams && (t = l(t, e.queryStringParams));
                                var r = Object(s.a)({}, "function" == typeof e.customHeaders ? e.customHeaders() : e.customHeaders);
                                ...
                                try {
                                    ...
                                    if (!o || 0 === Object.keys(o).length || !e.message || e.message.indexOf("not implemented") < 0) return i(e);
                                    try {
                            ...
                            }(e, t, n, a) : Object(s.b)() || "function" == typeof ActiveXObject ? function(e, t, n, i) {
                            ...
                            }(e, t, n, a) : void a(new Error("No fetch and no xhr implementation found!"))
                        }
                    }).call(this, n(21))
                }, function(e, t, n) {
                    "use strict";
                    ...
                    "use strict";
                    e.exports = n(38)() ? String.prototype.contains : n(39)
                }, function(e, t, n) {
                    "use strict";
                    var i = "razdwatrzy";
                    e.exports = function() {
                    ...
                    var Ne = {
                        ...
                        Me = function() {
                            ...
                            return t.formatWithSystemDefault = function(e, t) {
                                ...
                                var i = this,
                                    ...
                                    o = this.loc.outputCalendar && "gregory" !== this.loc.outputCalendar && G(),
                                    s = function(e, n) {
                        ...
                        Be = function(e) {
                            ...
                            return n.offsetName = function(e, t) {
                                ...
                                var n, i = (n = this.name, Ue[n] || (Ue[n] = new Intl.DateTimeFormat("en-US", {
                                        hour12: !1,
                                        timeZone: n,
                                        year: "numeric",
                                        month: "2-digit",
                    ...
                    function $e(e, t) {
                        ...
                        if ("string" == typeof e) {
                            var i = e.toLowerCase();
                            return "local" === i ? t : "utc" === i || "gmt" === i ? Je.utcInstance : null != (n = Be.parseGMTOffset(e)) ? Je.instance(n) : Be.isValidSpecifier(i) ? Be.create(e) : Je.parseSpecifier(i) || new Ze(e)
                        }
                        return Z(e) ? Je.instance(e) : "object" == typeof e && e.offset && "number" == typeof e.offset ? e : new Ze(e)
                    }
                    var We = function() {
                            return Date.now()
                        },
                    ...
                    var at = function() {
                            ...
                            return e.prototype.format = function(e) {
                                ...
                                return te(this.floor ? Math.floor(e) : re(e, 3), this.padTo)
                            }, e
                        }(),
                        ut = function() {
                            function e(e, t, n) {
                                ...
                                if (this.opts = n, this.hasIntl = W(), e.zone.universal && this.hasIntl) {
                                    var r = e.offset / 60 * -1,
                                        ...
                                        s = Be.isValidZone(o);
                                    0 !== e.offset && s ? (i = o, this.dt = e) : (i = "UTC", n.timeZoneName ? this.dt = e : this.dt = 0 === e.offset ? e : oi.fromMillis(e.ts + 60 * e.offset * 1e3))
                                } else "local" === e.zone.type ? this.dt = e : (this.dt = e, i = e.zone.name);
                                if (this.hasIntl) {
                                    var a = Object.assign({}, this.opts);
                                    i && (a.timeZone = i), this.dtf = nt(t, a)
                                }
                            }
                            var t = e.prototype;
                            return t.format = function() {
                                ...
                                var e = function(e) {
                                        switch (ye(X(e, ["weekday", "era", "year", "month", "day", "hour", "minute", "second", "timeZoneName", "hour12"]))) {
                                            case ye(k):
                                                return "M/d/yyyy";
                                            case ye(x):
                                                return "LLL d, yyyy";
                                    ...
                                    t = lt.create("en-US");
                                return Me.create(t).formatDateTimeFromString(this.dt, e)
                            ...
                            function e(e, t, n) {
                                this.opts = Object.assign({
                                    ...
                                    var n = t,
                                        ...
                                        o = rt[r];
                                    return o || (o = new Intl.RelativeTimeFormat(e, t), rt[r] = o), o
                                }(e, n))
                            }
                            var t = e.prototype;
                        ...
                        lt = function() {
                            ...
                            e.fromOpts = function(t) {
                                ...
                                return new e(o || (r ? "en-US" : function() {
                                    ...
                                    return ot = "en-US"
                                }()), n || et.defaultNumberingSystem, i || et.defaultOutputCalendar, o)
                            ...
                            return t.listingMode = function(e) {
                                ...
                                var i = this;
                                return void 0 === t && (t = !1), void 0 === n && (n = !0), st(this, e, n, Oe, (function() {
                                    var n = t ? {
                                            weekday: e,
                                            year: "numeric",
                                            month: "long",
                                ...
                                return void 0 === e && (e = !0), st(this, void 0, e, (function() {
                                    ...
                                    if (!t.meridiemCache) {
                                        ...
                                        t.meridiemCache = [oi.utc(2016, 11, 13, 9), oi.utc(2016, 11, 13, 19)].map((function(n) {
                                ...
                                var n = this;
                                return void 0 === t && (t = !0), st(this, e, t, Re, (function() {
                                    var t = {
                                        era: e
                                    };
                                    return n.eraCache[e] || (n.eraCache[e] = [oi.utc(-40, 1, 1), oi.utc(2017, 1, 1)].map((function(e) {
                                ...
                                get: function() {
                                    var e;
                                    return null == this.fastNumbersCached && (this.fastNumbersCached = (!(e = this).numberingSystem || "latn" === e.numberingSystem) && ("latn" === e.numberingSystem || !e.locale || e.locale.startsWith("en") || W() && "latn" === new Intl.DateTimeFormat(e.intl).resolvedOptions().numberingSystem)), this.fastNumbersCached
                                }
                            }]), e
                        }();
                    ...
                    function pt() {
                        ...
                        return function(e, n) {
                            var i, r = {};
                            for (i = 0; i < t.length; i++) r[t[i]] = ne(e[n + i]);
                            return [r, null, n + i]
                        }
                    }
                    var gt = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
                        mt = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
                        vt = RegExp("" + mt.source + gt.source + "?"),
                        yt = RegExp("(?:T" + vt.source + ")?"),
                        bt = pt("weekYear", "weekNumber", "weekDay"),
                        wt = pt("year", "ordinal"),
                        Et = RegExp(mt.source + " ?(?:" + gt.source + "|(" + ve.source + "))?"),
                        St = RegExp("(?: " + Et.source + ")?");
                    ...
                    function Ot(e, t) {
                        var n = !e[t] && !e[t + 1],
                            i = he(e[t + 1], e[t + 2]);
                        return [{}, n ? null : Je.instance(i), t + 3]
                    }

                    function Lt(e, t) {
                        return [{}, e[t] ? Be.create(e[t]) : null, t + 1]
                    }
                    var Tt = RegExp("^T?" + mt.source + "$"),
                        It = /^-?P(?:(?:(-?\d{1,9})Y)?(?:(-?\d{1,9})M)?(?:(-?\d{1,9})W)?(?:(-?\d{1,9})D)?(?:T(?:(-?\d{1,9})H)?(?:(-?\d{1,9})M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,9}))?S)?)?)$/;
                    ...
                    function Dt(e, t, n, i, r, o, s) {
                        ...
                        return s && (a.second = ne(s)), e && (a.weekday = e.length > 3 ? ke.indexOf(e) + 1 : xe.indexOf(e) + 1), a
                    }
                    ...
                    function Mt(e) {
                        var t, n = e[1],
                            ...
                            h = e[11],
                            f = Dt(n, o, r, i, s, a, u);
                        return t = c ? Rt[c] : l ? 0 : he(d, h), [f, new Je(t)]
                    }
                    ...
                    function Vt(e) {
                        var t = e[1],
                            n = e[2],
                            i = e[3];
                        return [Dt(t, e[4], i, n, e[5], e[6], e[7]), Je.utcInstance]
                    }
                    ...
                    function qt(e) {
                        var t = e[1],
                            ...
                            o = e[5],
                            s = e[6];
                        return [Dt(t, e[7], n, i, r, o, s), Je.utcInstance]
                    }
                    var Ut = dt(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, yt),
                        Ft = dt(/(\d{4})-?W(\d\d)(?:-?(\d))?/, yt),
                        zt = dt(/(\d{4})-?(\d{3})/, yt),
                        Bt = dt(vt),
                        Ht = ht(xt, Ct, Ot),
                        Jt = ht(bt, Ct, Ot),
                    ...
                    var an = function() {
                        function e(e) {
                            ...
                            this.values = e.values, this.loc = e.loc || lt.create(), this.conversionAccuracy = t ? "longterm" : "casual", this.invalid = e.invalid || null, this.matrix = t ? tn : en, this.isLuxonDuration = !0
                        }
                        e.fromMillis = function(t, n) {
                            ...
                            if (null == t || "object" != typeof t) throw new y("Duration.fromObject: argument expected to be an object, got " + (null === t ? "null" : typeof t));
                            return new e({
                            ...
                            if (void 0 === n && (n = null), !t) throw new y("need to specify a reason the Duration is invalid");
                            var i = t instanceof _e ? t : new _e(t, n);
                            if (et.throwOnInvalid) throw new g(i);
                            return new e({
                                invalid: i
                            })
                        ...
                        return t.toFormat = function(e, t) {
                            ...
                            return this.isValid ? Me.create(this.loc, n).formatDurationFromString(this, e) : "Invalid Duration"
                            ...
                            for (var t, n = un(e), i = {}, r = d(nn); !(t = r()).done;) {
                                var o = t.value;
                                (Q(n.values, o) || Q(this.values, o)) && (i[o] = n.get(o) + this.get(o))
                            }
                            return on(this, {
                                values: i
                            }, !0)
                            ...
                            return r && (o.conversionAccuracy = r), on(this, o)
                        }, t.as = function(e) {
                            ...
                            var e = this.toObject();
                            return function(e, t) {
                                rn.reduce((function(n, i) {
                                    return J(t[i]) ? n : (n && sn(e, t, n, t, i), i)
                                }), null)
                            }(this.matrix, e), on(this, {
                                values: e
                            }, !0)
                        }, t.shiftTo = function() {
                            ...
                            for (var r, o, s = {}, a = {}, u = this.toObject(), c = d(nn); !(o = c()).done;) {
                                var l = o.value;
                                if (n.indexOf(l) >= 0) {
                                    r = l;
                                    var h = 0;
                                    for (var f in a) h += this.matrix[f][l] * a[f], a[f] = 0;
                                    Z(u[l]) && (h += u[l]);
                                    var p = Math.trunc(h);
                                    for (var g in s[l] = p, a[l] = h - p, u) nn.indexOf(g) > nn.indexOf(l) && sn(this.matrix, u, g, s, l)
                                } else Z(u[l]) && (a[l] = u[l])
                            }
                            for (var m in a) 0 !== a[m] && (s[r] += m === r ? a[m] : a[m] / this.matrix[r][m]);
                            return on(this, {
                                values: s
                            }, !0).normalize()
                        }, t.negate = function() {
                    ...
                    var ln = function() {
                            ...
                            e.invalid = function(t, n) {
                                if (void 0 === n && (n = null), !t) throw new y("need to specify a reason the Interval is invalid");
                                var i = t instanceof _e ? t : new _e(t, n);
                                if (et.throwOnInvalid) throw new p(i);
                                return new e({
                                    invalid: i
                                })
                                ...
                                if (r && o) {
                                    var s, a, u, c;
                                    try {
                                        a = (s = oi.fromISO(r, n)).isValid
                                    } catch (o) {
                                        a = !1
                                    }
                                    try {
                                        c = (u = oi.fromISO(o, n)).isValid
                                    } catch (o) {
                                        c = !1
                                    }
                            ...
                            return t.length = function(e) {
                                ...
                                for (var o = i.map(si).filter((function(e) {
                                        return t.contains(e)
                                ...
                                for (var n, i, r = null, o = 0, s = [], a = t.map((function(e) {
                                    ...
                                    })), u = d((n = Array.prototype).concat.apply(n, a).sort((function(e, t) {
                        ...
                        dn = function() {
                            ...
                            return e.hasDST = function(e) {
                                ...
                                return (u || lt.create(r, s, l)).months(e)
                                ...
                                var n = void 0 === t ? {} : t,
                                    ...
                                    c = n.outputCalendar,
                                    l = void 0 === c ? "gregory" : c;
                                return (u || lt.create(r, s, l)).months(e, !0)
                                ...
                                var n = void 0 === t ? {} : t,
                                    ...
                                    s = void 0 === o ? null : o,
                                    a = n.locObj;
                                return ((void 0 === a ? null : a) || lt.create(r, s, null)).weekdays(e)
                                ...
                                var n = void 0 === t ? {} : t,
                                    ...
                                    s = void 0 === o ? null : o,
                                    a = n.locObj;
                                return ((void 0 === a ? null : a) || lt.create(r, s, null)).weekdays(e, !0)
                                ...
                                var n = (void 0 === t ? {} : t).locale,
                                    i = void 0 === n ? null : n;
                                return lt.create(i, null, "gregory").eras(e)
                            }, e.features = function() {
                                var e = !1,
                                    t = !1,
                                    n = !1,
                                ...
                                return t(function(e) {
                                    ...
                                    if (isNaN(t)) {
                                        ...
                                        for (var n = 0; n < e.length; n++) {
                                            ...
                                            if (-1 !== e[n].search(fn.hanidec)) t += gn.indexOf(e[n]);
                                            else
                                                for (var r in pn) {
                                                    var o = pn[r],
                                                        s = o[0],
                    ...
                    function wn(e) {
                        return e.replace(/\./g, "\\.?").replace(bn, yn)
                    }
                    ...
                    function Ln(e, t, n) {
                        var i = function(e, t) {
                                ...
                                return (n = Array.prototype).concat.apply(n, e.map((function(e) {
                                    return function(e, t) {
                                        ...
                                        var n = Me.macroTokenToFormatOpts(e.val);
                                        if (!n) return e;
                                        var i = Me.create(t, n).formatDateTimeParts((On || (On = oi.fromMillis(1555555555555)), On)).map((function(e) {
                                            return function(e, t, n) {
                                                var i = e.type,
                                                    r = e.value;
                                                if ("literal" === i) return {
                            ...
                            r = i.map((function(t) {
                                return n = t, r = mn(i = e), o = mn(i, "{2}"), s = mn(i, "{3}"), a = mn(i, "{4}"), u = mn(i, "{6}"), c = mn(i, "{1,2}"), l = mn(i, "{1,3}"), d = mn(i, "{1,6}"), h = mn(i, "{1,9}"), f = mn(i, "{2,4}"), p = mn(i, "{4,6}"), g = function(e) {
                                    return {
                                    ...
                                    switch (e.val) {
                                        case "G":
                                            return Sn(i.eras("short", !1), 0);
                                        case "GG":
                                            return Sn(i.eras("long", !1), 0);
                                        case "y":
                                            return vn(d);
                                        case "yy":
                                        case "kk":
                                        ...
                                        case "WW":
                                            return vn(o);
                                        case "MMM":
                                            return Sn(i.months("short", !0, !1), 1);
                                        case "MMMM":
                                            return Sn(i.months("long", !0, !1), 1);
                                        case "LLL":
                                            return Sn(i.months("short", !1, !1), 1);
                                        case "LLLL":
                                            return Sn(i.months("long", !1, !1), 1);
                                        case "o":
                                        case "S":
                                            return vn(l);
                                        case "ooo":
                                        ...
                                        case "u":
                                            return xn(h);
                                        case "a":
                                            return Sn(i.meridiems(), 0);
                                        case "E":
                                        case "c":
                                            return vn(r);
                                        case "EEE":
                                            return Sn(i.weekdays("short", !1, !1), 1);
                                        case "EEEE":
                                            return Sn(i.weekdays("long", !1, !1), 1);
                                        case "ccc":
                                            return Sn(i.weekdays("short", !0, !1), 1);
                                        case "cccc":
                                            return Sn(i.weekdays("long", !0, !1), 1);
                                        case "Z":
                                        case "ZZ":
                                ...
                                var n, i, r, o, s, a, u, c, l, d, h, f, p, g, m
                            })),
                            o = r.find((function(e) {
                        ...
                        var s = function(e) {
                            ...
                            f = h ? function(e) {
                                var t;
                                return t = J(e.Z) ? J(e.z) ? null : Be.create(e.z) : new Je(e.Z), J(e.q) || (e.M = 3 * (e.q - 1) + 1), J(e.h) || (e.h < 12 && 1 === e.a ? e.h += 12 : 12 === e.h && 0 === e.a && (e.h = 0)), 0 === e.G && e.y && (e.y = -e.y), J(e.u) || (e.S = ie(e.u)), [Object.keys(e).reduce((function(t, n) {
                                    var i = function(e) {
                                        switch (e) {
                                            case "S":
                                                return "millisecond";
                            ...
                            p = f[0],
                            g = f[1];
                        if (Q(h, "a") && Q(h, "H")) throw new m("Can't include meridiem when specifying 24-hour format");
                        return {
                            input: t,
                            tokens: i,
                            regex: c,
                    ...
                    function An(e, t) {
                        return new _e("unit out of range", "you specified " + t + " (of type " + typeof t + ") as a " + e + ", which is invalid")
                    }
                    ...
                    function _n(e) {
                        var t, n = e.weekYear,
                            ...
                            s = se(n),
                            a = 7 * i + r - o - 3;
                        a < 1 ? a += se(t = n - 1) : a > s ? (t = n + 1, a -= se(n)) : t = n;
                        var u = Nn(t, a),
                            c = u.month,
                            l = u.day;
                    ...
                    function Vn(e) {
                        var t = $(e.year),
                            n = ee(e.month, 1, 12),
                            i = ee(e.day, 1, ae(e.year, e.month));
                        return t ? n ? !i && An("day", e.day) : An("month", e.month) : An("year", e.year)
                    }
                    ...
                    function qn(e) {
                        var t = e.hour,
                            ...
                            i = e.second,
                            r = e.millisecond,
                            o = ee(t, 0, 23) || 24 === t && 0 === n && 0 === i && 0 === r,
                            s = ee(n, 0, 59),
                            a = ee(i, 0, 59),
                            u = ee(r, 0, 999);
                        return o ? s ? a ? !u && An("millisecond", r) : An("second", i) : An("minute", n) : An("hour", t)
                    }

                    function Un(e) {
                        return new _e("unsupported zone", 'the zone "' + e.name + '" is not supported')
                    }
                    ...
                    function zn(e, t) {
                        ...
                        return new oi(Object.assign({}, n, t, {
                            old: n
                        }))
                    }
                    ...
                    function Zn(e, t) {
                        var n = e.o,
                            ...
                            o = Object.assign({}, e.c, {
                                year: i,
                                month: r,
                                day: Math.min(e.c.day, ae(i, r)) + Math.trunc(t.days) + 7 * Math.trunc(t.weeks)
                            }),
                            s = an.fromObject({
                    ...
                    function $n(e, t, n, i, r) {
                        ...
                        if (e && 0 !== Object.keys(e).length) {
                            var a = t || s,
                                u = oi.fromObject(Object.assign(e, n, {
                                    zone: a,
                                    setZone: void 0
                                }));
                            return o ? u : u.setZone(s)
                        }
                        return oi.invalid(new _e("unparsable", 'the input "' + r + "\" can't be parsed as " + i))
                    }

                    function Wn(e, t, n) {
                        return void 0 === n && (n = !0), e.isValid ? Me.create(lt.create("en-US"), {
                            allowZ: n,
                            forceSimple: !0
                    ...
                    function Gn(e, t) {
                        ...
                        i && 0 === e.second && 0 === e.millisecond || (g += "basic" === p ? "ss" : ":ss", o && 0 === e.millisecond || (g += ".SSS")), (l || s) && h && (g += " "), l ? g += "z" : s && (g += "basic" === p ? "ZZZ" : "ZZ");
                        var m = Wn(e, g);
                        return u && (m = "T" + m), m
                    }
                    var Kn = {
                    ...
                    function ii(e, t) {
                        for (var n, i = d(Qn); !(n = i()).done;) {
                            var r = n.value;
                            J(e[r]) && (e[r] = Kn[r])
                        }
                        var o = Vn(e) || qn(e);
                        if (o) return oi.invalid(o);
                        var s = et.now(),
                            a = Jn(e, t.offset(s), t),
                            u = a[0],
                            c = a[1];
                    ...
                    function ri(e, t, n) {
                        var i = !!J(n.round) || n.round,
                            r = function(e, r) {
                                return e = re(e, i || n.calendary ? 0 : 2, !0), t.loc.clone(n).relFormatter(n).format(e, r)
                            },
                            o = function(i) {
                        ...
                        for (var s, a = d(n.units); !(s = a()).done;) {
                            var u = s.value,
                                c = o(u);
                    ...
                    var oi = function() {
                        function e(e) {
                            var t = e.zone || et.defaultZone,
                                n = e.invalid || (Number.isNaN(e.ts) ? new _e("invalid input") : null) || (t.isValid ? null : Un(t));
                            ...
                            if (!n)
                                if (e.old && e.old.ts === this.ts && e.old.zone.equals(t)) {
                                    ...
                                    i = Hn(this.ts, s), i = (n = Number.isNaN(i.year) ? new _e("invalid input") : null) ? null : i, r = n ? null : s
                                } this._zone = t, this.loc = e.loc || lt.create(), this.invalid = n, this.weekData = null, this.c = i, this.o = r, this.isLuxonDateTime = !0
                        }
                        e.now = function() {
                            return new e({})
                            ...
                            if (void 0 === n && (n = {}), Z(t)) return t < -864e13 || t > 864e13 ? e.invalid("Timestamp out of range") : new e({
                                ts: t,
                                zone: $e(n.zone, et.defaultZone),
                                loc: lt.fromObject(n)
                            });
                            throw new y("fromMillis requires a numerical input, but received a " + typeof t + " with value " + t)
                            ...
                            var n = $e(t.zone, et.defaultZone);
                            if (!n.isValid) return e.invalid(Un(n));
                            var i = et.now(),
                                r = n.offset(i),
                                o = pe(t, ni, ["zone", "locale", "outputCalendar", "numberingSystem"]),
                                s = !J(o.ordinal),
                                a = !J(o.year),
                                u = !J(o.month) || !J(o.day),
                                c = a || u,
                            ...
                            var f, p, g = l || o.weekday && !c,
                                v = Hn(i, r);
                            g ? (f = ei, p = Yn, v = Mn(v)) : s ? (f = ti, p = Xn, v = jn(v)) : (f = Qn, p = Kn);
                            for (var y, b = !1, w = d(f); !(y = w()).done;) {
                                var E = y.value;
                                J(o[E]) ? o[E] = b ? p[E] : v[E] : b = !0
                            }
                            var S = (g ? function(e) {
                                var t = $(e.weekYear),
                                    n = ee(e.weekNumber, 1, ce(e.weekYear)),
                                    i = ee(e.weekday, 1, 7);
                                return t ? n ? !i && An("weekday", e.weekday) : An("week", e.week) : An("weekYear", e.weekYear)
                            }(o) : s ? function(e) {
                                var t = $(e.year),
                                    n = ee(e.ordinal, 1, se(e.year));
                                return t ? !n && An("ordinal", e.ordinal) : An("year", e.year)
                            }(o) : Vn(o)) || qn(o);
                            if (S) return e.invalid(S);
                            var k = Jn(g ? _n(o) : s ? Pn(o) : o, r, n),
                                x = new e({
                                    ts: k[0],
                                    zone: n,
                                    o: k[1],
                            ...
                            return o.weekday && c && t.weekday !== x.weekday ? e.invalid("mismatched weekday", "you can't specify both a weekday of " + o.weekday + " and a date of " + x.toISO()) : x
                        }, e.fromISO = function(e, t) {
                            void 0 === t && (t = {});
                            var n = function(e) {
                                return ft(e, [Ut, Ht], [Ft, Jt], [zt, Zt], [Bt, $t])
                            }(e);
                            return $n(n[0], n[1], t, "ISO 8601", e)
                            ...
                            return $n(n[0], n[1], t, "RFC 2822", e)
                        }, e.fromHTTP = function(e, t) {
                            void 0 === t && (t = {});
                            var n = function(e) {
                                return ft(e, [_t, Vt], [jt, Vt], [Pt, qt])
                            }(e);
                            return $n(n[0], n[1], t, "HTTP", t)
                        }, e.fromFormat = function(t, n, i) {
                            if (void 0 === i && (i = {}), J(t) || J(n)) throw new y("fromFormat requires an input string and a format");
                            var r = i,
                                o = r.locale,
                                s = void 0 === o ? null : o,
                                a = r.numberingSystem,
                                ...
                                d = c[1],
                                h = c[2];
                            return h ? e.invalid(h) : $n(l, d, i, "format " + n, t)
                        }, e.fromString = function(t, n, i) {
                            return void 0 === i && (i = {}), e.fromFormat(t, n, i)
                        }, e.fromSQL = function(e, t) {
                            void 0 === t && (t = {});
                            var n = function(e) {
                                return ft(e, [Gt, Yt], [Kt, Xt])
                            }(e);
                            return $n(n[0], n[1], t, "SQL", e)
                        }, e.invalid = function(t, n) {
                            if (void 0 === n && (n = null), !t) throw new y("need to specify a reason the DateTime is invalid");
                            var i = t instanceof _e ? t : new _e(t, n);
                        ...
                        return t.get = function(e) {
                            ...
                            void 0 === e && (e = {});
                            var t = Me.create(this.loc.clone(e), e).resolvedOptions(this);
                            return {
                                locale: t.locale,
                            ...
                            var i = void 0 === n ? {} : n,
                                ...
                                a = void 0 !== s && s;
                            if ((t = $e(t, et.defaultZone)).equals(this.zone)) return this;
                            if (t.isValid) {
                                var u = this.ts;
                                if (o || a) {
                                    var c = t.offset(this.ts);
                                    u = Jn(this.toObject(), c, t)[0]
                                }
                                return zn(this, {
                                    ts: u,
                                    zone: t
                            ...
                            if (!this.isValid) return this;
                            var t, n = pe(e, ni, []),
                                i = !J(n.weekYear) || !J(n.weekNumber) || !J(n.weekday),
                                r = !J(n.ordinal),
                                o = !J(n.year),
                                s = !J(n.month) || !J(n.day),
                                a = o || s,
                            ...
                            i ? t = _n(Object.assign(Mn(this.c), n)) : J(n.ordinal) ? (t = Object.assign(this.toObject(), n), J(n.day) && (t.day = Math.min(ae(t.year, t.month), t.day))) : t = Pn(Object.assign(jn(this.c), n));
                            var c = Jn(t, this.o, this.zone);
                            return zn(this, {
                                ts: c[0],
                                o: c[1]
                            })
                        }, t.plus = function(e) {
                            return this.isValid ? zn(this, Zn(this, un(e))) : this
                        }, t.minus = function(e) {
                            return this.isValid ? zn(this, Zn(this, un(e).negate())) : this
                            ...
                            return void 0 === t && (t = {}), this.isValid ? Me.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : "Invalid DateTime"
                        }, t.toLocaleString = function(e) {
                            return void 0 === e && (e = k), this.isValid ? Me.create(this.loc.clone(e), e).formatDateTime(this) : "Invalid DateTime"
                        }, t.toLocaleParts = function(e) {
                            return void 0 === e && (e = {}), this.isValid ? Me.create(this.loc.clone(e), e).formatDateTimeParts(this) : []
                        }, t.toISO = function(e) {
                            ...
                            return this.year > 9999 && (n = "+" + n), Wn(this, n)
                            ...
                            var i, r = Object.assign({
                                ...
                                o = (i = t, Array.isArray(i) ? i : [i]).map(an.normalizeUnit),
                                ...
                                a = function(e, t, n, i) {
                                    var r, o = function(e, t, n) {
                                            for (var i, r, o = {}, s = 0, a = [
                                                ...
                                                if (n.indexOf(c) >= 0) {
                                                    ...
                                                    i = c;
                                                    var h, f = l(e, t);
                                                    (r = e.plus(((d = {})[c] = f, d))) > t ? (e = e.plus(((h = {})[c] = f - 1, h)), f -= 1) : e = r, o[c] = f
                                                }
                                            }
                                            return [e, o, r, i]
                                        }(e, t, n),
                                    ...
                                    var h, f = an.fromObject(Object.assign(a, i));
                                    return d.length > 0 ? (h = an.fromMillis(l, i)).shiftTo.apply(h, d).plus(f) : f
                            ...
                            var n = t.base || e.fromObject({
                                ...
                                o = t.unit;
                            return Array.isArray(t.unit) && (r = t.unit, o = void 0), ri(n, this.plus(i), Object.assign(t, {
                                numeric: "always",
                                units: r,
                                unit: o
                            }))
                        }, t.toRelativeCalendar = function(t) {
                            return void 0 === t && (t = {}), this.isValid ? ri(t.base || e.fromObject({
                                zone: this.zone
                    ...
                    function si(e) {
                        if (oi.isDateTime(e)) return e;
                        if (e && e.valueOf && Z(e.valueOf())) return oi.fromJSDate(e);
                        if (e && "object" == typeof e) return oi.fromObject(e);
                        throw new y("Unknown datetime argument: " + e + ", of type " + typeof e)
                    }
                    t.DateTime = oi, t.Duration = an, t.FixedOffsetZone = Je, t.IANAZone = Be, t.Info = dn, t.Interval = ln, t.InvalidZone = Ze, t.LocalZone = Ve, t.Settings = et, t.VERSION = "1.28.1", t.Zone = je
                }, function(e, t, n) {
                    "use strict";
                    var i = n(43);
                    e.exports = function(e) {
                    ...
                    }, u.Cancel = n(20), u.CancelToken = n(61), u.isCancel = n(18), u.all = function(e) {
                        return Promise.all(e)
                    }, u.spread = n(62), u.isAxiosError = n(63), e.exports = u, e.exports.default = u
                }, function(e, t, n) {
                    "use strict";
                    var i = n(1),
                        r = n(14),
                    ...
                    var s = function() {
                        ...
                        a = function() {
                            function e(t) {
                                ...
                                (function(e, t) {
                                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                                })(this, e), this.services = t, this.options = n, this.allOptions = i, this.type = "backend", this.init(t, n, i)
                            }
                            var t, n;
                            return t = e, (n = [{
                                key: "init",
                                value: function(e) {
                                    ...
                                    this.services = e, this.options = Object(i.a)(n, this.options || {}, s()), this.allOptions = r, this.services && this.options.reloadInterval && setInterval((function() {
                                        return t.reload()
                    ...
                    ! function(e) {
                        ! function(t) {
                            ...
                            k.polyfill = !0, e.fetch || (e.fetch = k, e.Headers = h, e.Request = b, e.Response = E), t.Headers = h, t.Request = b, t.Response = E, t.fetch = k, Object.defineProperty(t, "__esModule", {
                                value: !0
                            })
                        }({})
                    ...
                    var u = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
                        c = function(e, t, n, i) {
                            ...
                            n && (r.expires = new Date, r.expires.setTime(r.expires.getTime() + 60 * n * 1e3)), i && (r.domain = i), document.cookie = function(e, t, n) {
                                var i = n || {};
                                i.path = i.path || "/";
                        ...
                        l = {
                            ...
                            cacheUserLanguage: function(e, t) {
                                t.lookupCookie && "undefined" != typeof document && c(t.lookupCookie, e, t.cookieMinutes, t.cookieDomain, t.cookieOptions)
                            }
                        },
                        d = {
                            name: "querystring",
                        ...
                        p = {
                            ...
                            cacheUserLanguage: function(e, t) {
                                t.lookupLocalStorage && f() && window.localStorage.setItem(t.lookupLocalStorage, e)
                            }
                        },
                        g = null,
                        m = function() {
                        ...
                        S = function() {
                            ...
                            return Object(r.a)(e, [{
                                ...
                                value: function(e) {
                                    ...
                                    }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(l), this.addDetector(d), this.addDetector(p), this.addDetector(v), this.addDetector(y), this.addDetector(b), this.addDetector(w), this.addDetector(E)
                                }
                            }, {
                                key: "addDetector",
                                value: function(e) {
                    ...
                    S.type = "languageDetector", t.default = S
                }, function(e, t, n) {
                    "use strict";
                    ...
                    const c = {
                        ...
                        m = e => e.actionsChannels.createDestination("fireGeneralAcknowledgeNotification/Res", l),
                        v = e => e.actionsChannels.createSource("addCustomTask", c),
                        ...
                        E = e => e.actionsChannels.createDestination("getTaskMap/Res", d),
                        S = e => e.actionsChannels.createSource("getMediaTypeQueue/Req", l),
                        k = e => e.actionsChannels.createDestination("getMediaTypeQueue/Res", d),
                        x = e => e.actionsChannels.createSource("getIdleCodes/Req", l),
                        C = e => e.actionsChannels.createDestination("getIdleCodes/Res", d),
                        O = e => e.actionsChannels.createSource("getWrapUpCodes/Req", l),
                        L = e => e.actionsChannels.createDestination("getWrapUpCodes/Res", d);
                    class T {
                        constructor(e) {
                            this.lastReqTs = Date.now(), this.lastReqN = 0, this.toggleMiximizeRestore = e => {
                                var t;
                                if (e && e.target) {
                                    const n = null === (t = this.getClosestElement(e.target, ".dynamic-widget-wrapper")) || void 0 === t ? void 0 : t.id;
                                    if (n) {
                                        const e = new CustomEvent("toggle-maximize-restore", {
                                            detail: {
                                                widgetId: n
                                            }
                                        });
                                        window.dispatchEvent(e), r.info("Dispatching toggle-maximize-restore event for widgetId:", n)
                                    }
                                }
                                ...
                                const e = new CustomEvent("ax-web-call-mute-unmute", {});
                                window.dispatchEvent(e), r.info("Dispatching ax-web-call-mute-unmute event")
                            }, this.declineWebRtcCall = () => {
                                const e = new CustomEvent("ax-web-call-decline", {});
                                window.dispatchEvent(e), r.info("Dispatching ax-web-call-decline event")
                            }, this.acceptWebRtcCall = () => {
                                const e = new CustomEvent("ax-web-call-answer", {});
                                window.dispatchEvent(e), r.info("Dispatching ax-web-call-answer event")
                        ...
                        getClosestElement(e, t) {
                            return e && e !== document && e !== window ? e instanceof ShadowRoot ? this.getClosestElement(e.host, t) : e instanceof HTMLElement && e.matches(t) ? e : this.getClosestElement(e.parentNode, t) : null
                        }
                    }
                    ...
                    class N {
                        ...
                        sendDtmf(e) {
                            this.checkService() && this.SERVICE.webCalling.sendDTMF(e)
                        }
                        accept(e) {
                            var t;
                    ...
                    class z {
                        constructor(e) {
                            this.emitter = P()(), this.listeners = new Set, this.teams = [], this.idleCodes = {}, this.latestData = Object.assign({}, F), this.logger = e.logger, this.serviceChecker = e.serviceChecker
                        }
                        checkService() {
                            return this.serviceChecker.check(this.SERVICE)
                        }
                        ...
                        fetchLatestData() {
                            var e, t, n, i, r, o;
                            return U(this, void 0, void 0, (function*() {
                                const s = (null === (e = this.SERVICE) || void 0 === e ? void 0 : e.conf.profile) ? null === (t = this.SERVICE) || void 0 === t ? void 0 : t.conf.profile : yield null === (n = this.SERVICE) || void 0 === n ? void 0 : n.conf.fetchProfile();
                                if (s) {
                                    const {
                                        teams: e,
                                        agentName: t,
                                        ...
                                        wrapupCodes: d,
                                        dialPlan: h,
                                        isOutboundEnabledForTenant: f,
                                        isOutboundEnabledForAgent: p,
                                        isAdhocDialingEnabled: g,
                                        isEndCallEnabled: m,
                                        isEndConsultEnabled: v,
                                        allowConsultToQueue: y,
                                        isAgentAvailableAfterOutdial: b,
                                        isCampaignManagementEnabled: w,
                                        agentPersonalStatsEnabled: E
                                    } = s;
                                    let {
                                        idleCode: S
                                    } = s;
                                    ...
                                    let x = c,
                                        C = u;
                                    this.teams = e, l.forEach((e => {
                                        this.idleCodes[e.id] = {
                                            id: e.id,
                                            name: e.name
                                        }
                                    }));
                                    const O = yield null === (i = this.SERVICE) || void 0 === i ? void 0 : i.aqm.agent.reload();
                                    (null == O ? void 0 : O.data) && (S = "0" != O.data.auxCodeId ? this.idleCodes[O.data.auxCodeId] : void 0, x = null === (r = null == O ? void 0 : O.data) || void 0 === r ? void 0 : r.status, C = null === (o = null == O ? void 0 : O.data) || void 0 === o ? void 0 : o.subStatus);
                                    const L = z.getOutdialRegex(h);
                                    this.update({
                                        agentName: t,
                                        agentProfileID: n,
                                        dn: k,
                            ...
                            if (this.checkService()) {
                                {
                                    const t = null === (e = this.SERVICE) || void 0 === e ? void 0 : e.aqm.agent.eAgentReloginSuccess.listen((({
                                        ...
                                        const s = z.findTeamName(this.teams, t);
                                        this.update({
                                            agentSessionId: e,
                                            teamId: t,
                                            teamName: s,
                                    ...
                                    const e = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.agent.eAgentStationLoginSuccess.listen((({
                                        ...
                                        const o = z.findTeamName(this.teams, t);
                                        this.update({
                                            agentSessionId: e,
                                            teamId: t,
                                            teamName: o,
                        ...
                        changeAgentState(e, t) {
                            var n;
                            return U(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = this.SERVICE) || void 0 === n ? void 0 : n.aqm.supervisor.changeAgentState({
                                    orgId: e,
                                    data: t
                                })
                            }))
                        }
                        fetchAgentIdleCodes(e, t) {
                            var n;
                            return U(this, void 0, void 0, (function*() {
                                if (this.checkService()) return yield null === (n = this.SERVICE) || void 0 === n ? void 0 : n.abs.fetchAgentIdleCodes({
                                    orgId: e,
                                    agentId: t
                                })
                            }))
                        ...
                        fetchOrganizationIdleCodes(e) {
                            var t;
                            return U(this, void 0, void 0, (function*() {
                                if (this.checkService()) return yield null === (t = this.SERVICE) || void 0 === t ? void 0 : t.abs.fetchIdleCodes({
                                    orgId: e,
                                    accessType: "ALL"
                                })
                            }))
                    ...
                    const G = o(r, "[Dialer JSAPI] =>"),
                        K = o(G, "[AqmServiceEvents: Dialer] =>");
                    class Y {
                        constructor(e) {
                            this.logger = e.logger, this.serviceChecker = e.serviceChecker
                        }
                    ...
                    class ae {
                        constructor(e) {
                            this.emitter = P()(), this.logger = e.logger
                        }
                        waitUntil(e) {
                        ...
                        checkService() {
                            var e, t, n, i, r;
                            return se(this, void 0, void 0, (function*() {
                                window.wxcc && (null === (e = window.wxcc) || void 0 === e ? void 0 : e.rtdwc) ? ((null === (n = null === (t = window.wxcc) || void 0 === t ? void 0 : t.rtdwc) || void 0 === n ? void 0 : n.error) && (this.logger.error("RTDWC initialization failed. Awaiting Websocket connection to establish", null === (r = null === (i = window.wxcc) || void 0 === i ? void 0 : i.rtdwc) || void 0 === r ? void 0 : r.error), yield this.waitUntil((() => {
                                    var e, t;
                                    return !(null === (t = null === (e = window.wxcc) || void 0 === e ? void 0 : e.rtdwc) || void 0 === t ? void 0 : t.error)
                        ...
                        subscribe({
                            ...
                            var i, r;
                            return se(this, void 0, void 0, (function*() {
                                return yield this.checkService(), yield null === (r = null === (i = window.wxcc) || void 0 === i ? void 0 : i.rtdwc) || void 0 === r ? void 0 : r.subscribe({
                                    datasetName: e,
                                    update: t,
                                    error: n
                                })
                    ...
                    class le {
                        ...
                        startMonitoring(e) {
                            ...
                            return ce(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.supervisor) || void 0 === n ? void 0 : n.startMonitoring(e)
                            }))
                        }
                        endMonitoring(e) {
                            var t, n;
                            return ce(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.supervisor) || void 0 === n ? void 0 : n.endMonitoring(e)
                            }))
                        }
                        holdMonitoring(e) {
                            var t, n;
                            return ce(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.supervisor) || void 0 === n ? void 0 : n.holdMonitoring(e)
                            }))
                        }
                        unHoldMonitoring(e) {
                            var t, n;
                            return ce(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.supervisor) || void 0 === n ? void 0 : n.unHoldMonitoring(e)
                            }))
                        }
                        bargeIn(e) {
                            var t, n;
                            return ce(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.supervisor) || void 0 === n ? void 0 : n.bargeIn(e)
                            }))
                        }
                        addEventListener(e, t) {
                            this.checkService() && this.aqmEvents.addEventListener(e, t)
                    ...
                    const de = o(r, "[Call Monitoring JSAPI] =>"),
                        he = o(de, "[AqmServiceEvents: Call Monitoring] =>");
                    class fe {
                        constructor(e) {
                            this.logger = e.logger, this.aqmEvents = e.aqmEvents, this.serviceChecker = e.serviceChecker
                        }
                        ...
                        desktopLogout(e) {
                            ...
                            return function(e, t, n, i) {
                                ...
                                const i = yield be.actions.getTaskMap();
                                if (0 !== (null == i ? void 0 : i.size)) throw new Error("You cannot sign out now because you have active conversations. Complete them and try again.");
                                return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.aqm.agent) || void 0 === n ? void 0 : n.logout(e)
                            }))
                        }
                        addEventListener(e, t) {
                            this.checkService() && this.aqmEvents.addEventListener(e, t)
                    ...
                    const pe = o(r, "[Station Logout JSAPI] =>"),
                        ge = o(pe, "[AqmServiceEvents: Call Monitoring] =>");
                    ...
                    class ve {
                        ...
                        fetchTasks(e) {
                            ...
                            return me(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.qmw) || void 0 === n ? void 0 : n.fetchTasks(e)
                            }))
                        }
                        fetchCapture(e) {
                            var t, n;
                            return me(this, void 0, void 0, (function*() {
                                if (this.checkService()) return null === (n = null === (t = this.SERVICE) || void 0 === t ? void 0 : t.qmw) || void 0 === n ? void 0 : n.fetchCapture(e)
                            }))
                        }
                    }
                    const ye = o(r, "[PI JSAPI] =>"),
                        be = (() => {
                            ...
                            return e.addEventListener("inited", (() => {
                                u.init(AGENTX_SERVICE), s.init(AGENTX_SERVICE), c.init(AGENTX_SERVICE), l.init(AGENTX_SERVICE), d.init(AGENTX_SERVICE), h.init(AGENTX_SERVICE), g.init(AGENTX_SERVICE), i.init(AGENTX_SERVICE), o.init(AGENTX_SERVICE), f.init(AGENTX_SERVICE)
                            })), e.addEventListener("cleaned", (() => {
                                u.cleanup(), s.cleanup(), c.cleanup(), l.cleanup(), d.cleanup(), h.cleanup(), g.cleanup(), i.cleanup(), f.cleanup(), o.cleanup()
                            })), {
                                config: e,
                                logger: n,
                                monitoring: l,
                    ...
                    var u, c, l = function(e, t) {
                        ...
                        f = function(e, t, n) {
                            ...
                            if (null == s || null == a) {
                                var f = e.random || (e.rng || o)();
                                null == s && (s = u = [1 | f[0], f[1], f[2], f[3], f[4], f[5]]), null == a && (a = c = 16383 & (f[6] << 8 | f[7]))
                            }
                            var p = void 0 !== e.msecs ? e.msecs : (new Date).getTime(),
                                g = void 0 !== e.nsecs ? e.nsecs : h + 1,
                                m = p - d + (g - h) / 1e4;
                            if (m < 0 && void 0 === e.clockseq && (a = a + 1 & 16383), (m < 0 || p > d) && void 0 === e.nsecs && (g = 0), g >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                            d = p, h = g, c = a;
                            var v = (1e4 * (268435455 & (p += 122192928e5)) + g) % 4294967296;
                            r[i++] = v >>> 24 & 255, r[i++] = v >>> 16 & 255, r[i++] = v >>> 8 & 255, r[i++] = 255 & v;
                    ...
                    function v(e, t, n, i, r, o, s) {
                        return m(t & n | ~t & i, e, t, r, o, s)
                    }

                    function y(e, t, n, i, r, o, s) {
                        return m(t & i | n & ~i, e, t, r, o, s)
                    }

                    function b(e, t, n, i, r, o, s) {
                        return m(t ^ n ^ i, e, t, r, o, s)
                    }

                    function w(e, t, n, i, r, o, s) {
                        return m(n ^ (t | ~i), e, t, r, o, s)
                    }
                    var E = p("v3", 48, (function(e) {
                            if ("string" == typeof e) {
                    ...
                    var C = p("v5", 80, (function(e) {
                        ...
                        for (a[s - 1][14] = 8 * (e.length - 1) / Math.pow(2, 32), a[s - 1][14] = Math.floor(a[s - 1][14]), a[s - 1][15] = 8 * (e.length - 1) & 4294967295, r = 0; r < s; r++) {
                            ...
                            for (l = 16; l < 80; l++) c[l] = x(c[l - 3] ^ c[l - 8] ^ c[l - 14] ^ c[l - 16], 1);
                            var d = n[0],
                                h = n[1],
                                f = n[2],
                                p = n[3],
                                g = n[4];
                            for (l = 0; l < 80; l++) {
                                var m = Math.floor(l / 20),
                                    v = x(d, 5) + k(m, h, f, p) + g + t[m] + c[l] >>> 0;
                                g = p, p = f, f = x(h, 30) >>> 0, h = d, d = v
                            }
                            n[0] = n[0] + d >>> 0, n[1] = n[1] + h >>> 0, n[2] = n[2] + f >>> 0, n[3] = n[3] + p >>> 0, n[4] = n[4] + g >>> 0
                        }
                    ...
                    var L = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
                        T = function(e) {
                            function t(e) {
                                ...
                                return Object(a.a)(this, t), n = l(this, d(t).call(this)), L && m.call(c(n)), n.data = e || {}, n.options = i, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n
                            }
                            return f(t, e), Object(u.a)(t, [{
                                key: "addNamespaces",
                                value: function(e) {
                                ...
                                value: function(e, t, n) {
                                    var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                                        ...
                                        o = [e, t];
                                    return n && "string" != typeof n && (o = o.concat(n)), n && "string" == typeof n && (o = o.concat(r ? n.split(r) : n)), e.indexOf(".") > -1 && (o = e.split(".")), E(this.data, o)
                                }
                            }, {
                                key: "addResource",
                                value: function(e, t, n, i) {
                                    ...
                                    void 0 === o && (o = ".");
                                    var s = [e, t];
                                    n && (s = s.concat(o ? n.split(o) : n)), e.indexOf(".") > -1 && (i = t, t = (s = e.split("."))[1]), this.addNamespaces(t), w(this.data, s, i), r.silent || this.emit("added", e, t, n, i)
                                }
                            }, {
                                key: "addResources",
                                value: function(e, t, n) {
                                ...
                                value: function(e, t, n, i, r) {
                                    ...
                                    var u = E(this.data, a) || {};
                                    i ? k(u, n, r) : u = s({}, u, n), w(this.data, a, u), o.silent || this.emit("added", e, t, n)
                                }
                            }, {
                        ...
                        R = function(e) {
                            function t(e) {
                                var n, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                return Object(a.a)(this, t), n = l(this, d(t).call(this)), L && m.call(c(n)),
                                    function(e, t, n) {
                                        e.forEach((function(e) {
                                            t[e] && (n[e] = t[e])
                                        }))
                                    }(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, c(n)), n.options = i, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n.logger = g.create("translator"), n
                            }
                            return f(t, e), Object(u.a)(t, [{
                                key: "changeLanguage",
                                value: function(e) {
                                ...
                                value: function(e, n, r) {
                                    var o = this;
                                    if ("object" !== Object(i.a)(n) && this.options.overloadTranslationOptionHandler && (n = this.options.overloadTranslationOptionHandler(arguments)), n || (n = {}), null == e) return "";
                                    ...
                                    if (E && m && "string" != typeof m && "boolean" != typeof m && "number" != typeof m && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(b) < 0 && ("string" != typeof w || "[object Array]" !== b)) {
                                        if (!n.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(v, m, n) : "key '".concat(c, " (").concat(this.language, ")' returned an object instead of string.");
                                        if (a) {
                                            ...
                                            for (var C in m)
                                                if (Object.prototype.hasOwnProperty.call(m, C)) {
                                                    var O = "".concat(x).concat(a).concat(C);
                                                    k[C] = this.translate(O, s({}, n, {
                                                        joinArrays: !1,
                                                        ns: l
                                                    })), k[C] === O && (k[C] = m[C])
                                                } m = k
                                        }
                                    } else if (E && "string" == typeof w && "[object Array]" === b)(m = m.join(w)) && (m = this.extendTranslation(m, e, n, r));
                                    else {
                                        var L = !1,
                                            T = !1,
                                            I = void 0 !== n.count && "string" != typeof n.count,
                                            A = t.hasDefaultValue(n),
                                            R = I ? this.pluralResolver.getSuffix(h, n.count) : "",
                                            D = n["defaultValue".concat(R)] || n.defaultValue;
                                        !this.isValidLookup(m) && A && (L = !0, m = D), this.isValidLookup(m) || (T = !0, m = c);
                                        var N = A && D !== m && this.options.updateMissing;
                                        if (T || L || N) {
                                            if (this.logger.log(N ? "updateKey" : "missingKey", h, d, c, N ? D : m), a) {
                                                var M = this.resolve(c, s({}, n, {
                                                    keySeparator: !1
                                                }));
                                            ...
                                            if ("fallback" === this.options.saveMissingTo && j && j[0])
                                                for (var P = 0; P < j.length; P++) _.push(j[P]);
                                            else "all" === this.options.saveMissingTo ? _ = this.languageUtils.toResolveHierarchy(n.lng || this.language) : _.push(n.lng || this.language);
                                            var V = function(e, t, i) {
                                                o.options.missingKeyHandler ? o.options.missingKeyHandler(e, d, t, N ? i : m, N, n) : o.backendConnector && o.backendConnector.saveMissing && o.backendConnector.saveMissing(e, d, t, N ? i : m, N, n), o.emit("missingKey", e, d, t, m)
                                            };
                                            this.options.saveMissing && (this.options.saveMissingPlurals && I ? _.forEach((function(e) {
                                                o.pluralResolver.getSuffixes(e).forEach((function(t) {
                                                    V([e], c + t, n["defaultValue".concat(t)] || D)
                                                }))
                                            })) : V(_, c, D))
                                        }
                                        m = this.extendTranslation(m, e, n, g, r), T && m === c && this.options.appendNamespaceToMissingKey && (m = "".concat(d, ":").concat(c)), T && this.options.parseMissingKeyHandler && (m = this.options.parseMissingKeyHandler(m))
                                    }
                                    return m
                                }
                            }, {
                                ...
                                value: function(e, t, n, i, r) {
                                    ...
                                    if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, n, i.usedLng, i.usedNS, i.usedKey, {
                                        ...
                                        if (this.options.interpolation.defaultVariables && (l = s({}, this.options.interpolation.defaultVariables, l)), e = this.interpolator.interpolate(e, l, n.lng || this.language, n), u) {
                                    ...
                                    return null != e && f && f.length && !1 !== n.applyPostProcessor && (e = I.handle(f, e, t, this.options && this.options.postProcessPassResolved ? s({
                                        i18nResolved: i
                                    }, n) : n, this)), e
                                }
                            }, {
                                    ...
                                    return "string" == typeof e && (e = [e]), e.forEach((function(e) {
                                        if (!s.isValidLookup(t)) {
                                            ...
                                            l.forEach((function(e) {
                                                s.isValidLookup(t) || (o = e, !A["".concat(f[0], "-").concat(e)] && s.utils && s.utils.hasLoadedNamespace && !s.utils.hasLoadedNamespace(o) && (A["".concat(f[0], "-").concat(e)] = !0, s.logger.warn('key "'.concat(n, '" for languages "').concat(f.join(", "), '" won\'t get resolved as namespace "').concat(o, '" was not yet loaded'), "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), f.forEach((function(n) {
                                                    if (!s.isValidLookup(t)) {
                                                        r = n;
                                                        var o, u, l = c,
                                                            f = [l];
                                                        for (s.i18nFormat && s.i18nFormat.addLookupKeys ? s.i18nFormat.addLookupKeys(f, c, n, e, a) : (d && (o = s.pluralResolver.getSuffix(n, a.count)), d && h && f.push(l + o), h && f.push(l += "".concat(s.options.contextSeparator).concat(a.context)), d && f.push(l += o)); u = f.pop();) s.isValidLookup(t) || (i = u, t = s.getResource(n, e, u, a))
                                                    }
                                                })))
                                            }))
                                        }
                    ...
                    var N = function() {
                            function e(t) {
                                Object(a.a)(this, e), this.options = t, this.whitelist = this.options.supportedLngs || !1, this.supportedLngs = this.options.supportedLngs || !1, this.logger = g.create("languageUtils")
                            }
                            return Object(u.a)(e, [{
                    ...
                    var j = function() {
                            function e(t) {
                                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                Object(a.a)(this, e), this.languageUtils = t, this.options = n, this.logger = g.create("pluralResolver"), this.rules = function() {
                                    var e = {};
                        ...
                        P = function() {
                            function e() {
                                ...
                                Object(a.a)(this, e), this.logger = g.create("interpolator"), this.options = t, this.format = t.interpolation && t.interpolation.format || function(e) {
                                    return e
                                }, this.init(t)
                            }
                            return Object(u.a)(e, [{
                                ...
                                value: function(e, t, n, i) {
                                    ...
                                    return [{
                                        ...
                                        for (s = 0; r = t.regex.exec(e);) {
                                            ...
                                            else "string" == typeof o || a.useRawValueToEscape || (o = y(o));
                                ...
                                value: function(e, t) {
                                    ...
                                    for (a.applyPostProcessor = !1, delete a.defaultValue; n = this.nestingRegexp.exec(e);) {
                                        ...
                                        "string" != typeof i && (i = y(i)), i || (this.logger.warn("missed to resolve ".concat(n[1], " for nesting ").concat(e)), i = ""), l && (i = c.reduce((function(e, t) {
                        ...
                        V = function(e) {
                            function t(e, n, i) {
                                ...
                                return Object(a.a)(this, t), r = l(this, d(t).call(this)), L && m.call(c(r)), r.backend = e, r.store = n, r.services = i, r.languageUtils = i.languageUtils, r.options = o, r.logger = g.create("backendConnector"), r.state = {}, r.queue = [], r.backend && r.backend.init && r.backend.init(i, o.backend, o), r
                            }
                            return f(t, e), Object(u.a)(t, [{
                                key: "queueLoad",
                                value: function(e, t, n, i) {
                    ...
                    function q() {
                        return {
                            ...
                            overloadTranslationOptionHandler: function(e) {
                                var t = {};
                                if ("object" === Object(i.a)(e[1]) && (t = e[1]), "string" == typeof e[1] && (t.defaultValue = e[1]), "string" == typeof e[2] && (t.tDescription = e[2]), "object" === Object(i.a)(e[2]) || "object" === Object(i.a)(e[3])) {
                                    var n = e[3] || e[2];
                    ...
                    var z = new(function(e) {
                        function t() {
                            ...
                            if (Object(a.a)(this, t), e = l(this, d(t).call(this)), L && m.call(c(e)), e.options = U(n), e.services = {}, e.logger = g, e.modules = {
                                    external: []
                        ...
                        return f(t, e), Object(u.a)(t, [{
                            ...
                            value: function() {
                                ...
                                if ("function" == typeof t && (n = t, t = {}), t.whitelist && !t.supportedLngs && this.logger.deprecate("whitelist", 'option "whitelist" will be renamed to "supportedLngs" in the next major - please make sure to rename this option asap.'), t.nonExplicitWhitelist && !t.nonExplicitSupportedLngs && this.logger.deprecate("whitelist", 'options "nonExplicitWhitelist" will be renamed to "nonExplicitSupportedLngs" in the next major - please make sure to rename this option asap.'), this.options = s({}, q(), this.options, U(t)), this.format = this.options.interpolation.format, n || (n = F), !this.options.isClone) {
                                    ...
                                    var o = this.services;
                                    o.logger = g, o.resourceStore = this.store, o.languageUtils = r, o.pluralResolver = new j(r, {
                                        prepend: this.options.pluralSeparator,
                                        compatibilityJSON: this.options.compatibilityJSON,
                                        simplifyPluralSuffix: this.options.simplifyPluralSuffix
                                    }), o.interpolator = new P(this.options), o.utils = {
                                        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                                    }, o.backendConnector = new V(i(this.modules.backend), o.resourceStore, o, this.options), o.backendConnector.on("*", (function(t) {
                            ...
                            value: function(e, t, n) {
                                var i = v();
                                return e || (e = this.languages), t || (t = this.options.ns), n || (n = F), this.services.backendConnector.reload(e, t, (function(e) {
                                    i.resolve(), n(e)
                                })), i
                            }
                        }, {
                            ...
                            value: function() {
                                var e = this,
                                    ...
                                    i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : F,
                                    r = s({}, this.options, n, {
                                        isClone: !0
                                    }),
                                    o = new t(r);
                                return ["store", "services", "language"].forEach((function(t) {
                                    o[t] = e[t]
                                })), o.services = s({}, this.services), o.services.utils = {
                                    hasLoadedNamespace: o.hasLoadedNamespace.bind(o)
                                }, o.translator = new R(o.services, o.options), o.translator.on("*", (function(e) {
                                    for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++) n[i - 1] = arguments[i];
    ...
    n.d = (e, t) => {
        ...
        "use strict";
        var e = n(124);
        const t = e.Desktop.logger.createLogger("cisco-conference-speed-dial");
        class i extends HTMLElement {
            ...
            constructor() {
                super(), t.info("lee-health-wxcc-consult-buttons version 1.0"), t.info("JS Step 1 - attachShadow"), this.attachShadow({
                    mode: "open"
                }), t.debug("Requesting Button Map Update from background process in constructor... ")
            }
            async connectedCallback() {
                t.debug("*/*/*/*/*/*/*/*/*/*/*/*/*/*/ Connected Callback */*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/"), t.debug("connectedCallback in UI Widget"), !1 === this.initialized ? (t.debug("Not previously initialized - doing Desktop.config.init()"), await e.Desktop.config.init()) : (t.debug("Previously initialized - skipping Desktop.config.init()"), this.removeButtonPressListener()), t.debug("Removing Old Event Listeners"), this.removeListeners(), t.debug("Initializing Event Listeners"), this.initListeners(), t.debug("Adding Button Press Listener"), this.addButtonPressListener(), t.debug("Getting Call State"), this.latestCallState = await this.getCallState(), t.debug("Rendering template"), this.render(), this.initialized = !0
            }
            async disconnectedCallback() {
                t.debug("*/*/*/*/*/*/*/*/*/*/*/*/*/*/ Disconnected Callback */*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/"), this.removeButtonPressListener(), this.removeListeners(), t.debug("disconnectedCallback in UI Widget")
            }
            initListeners() {
                t.info("Adding WebexCC Event Listeners"), e.Desktop.agentContact.addEventListener("eAgentContact", (e => this.logEvent(e, "eAgentContact"))), e.Desktop.agentContact.addEventListener("eAgentContactAssigned", (e => this.logEvent(e, "eAgentContactAssigned"))), e.Desktop.agentContact.addEventListener("eAgentContactAssignFailed", (e => this.logEvent(e, "eAgentContactAssignFailed"))), e.Desktop.agentContact.addEventListener("eAgentContactEnded", (e => this.logEvent(e, "eAgentContactEnded"))), e.Desktop.agentContact.addEventListener("eAgentContactWrappedUp", (e => this.logEvent(e, "eAgentContactWrappedUp"))), e.Desktop.agentContact.addEventListener("eAgentOfferContact", (e => this.logEvent(e, "eAgentOfferContact"))), e.Desktop.agentContact.addEventListener("eAgentOfferContactRona", (e => this.logEvent(e, "eAgentOfferContactRona"))), e.Desktop.agentContact.addEventListener("eAgentOfferConsult", (e => this.logEvent(e, "eAgentOfferConsult"))), e.Desktop.agentContact.addEventListener("eAgentWrapup", (e => this.logEvent(e, "eAgentWrapup"))), e.Desktop.agentContact.addEventListener("eAgentContactHeld", (e => this.logEvent(e, "eAgentContactHeld"))), e.Desktop.agentContact.addEventListener("eAgentContactUnHeld", (e => this.logEvent(e, "eAgentContactUnHeld"))), e.Desktop.agentContact.addEventListener("eConsultTransfer", (e => this.logEvent(e, "eConsultTransfer"))), e.Desktop.agentContact.addEventListener("eAgentConsultCreated", (e => this.logEvent(e, "eAgentConsultCreated"))), e.Desktop.agentContact.addEventListener("eAgentConsultConferenced", (e => this.logEvent(e, "eAgentConsultConferenced"))), e.Desktop.agentContact.addEventListener("eAgentConsultEnded", (e => this.logEvent(e, "eAgentConsultEnded"))), e.Desktop.agentContact.addEventListener("eAgentConsultConferenceEnded", (e => this.logEvent(e, "eAgentConsultConferenceEnded"))), e.Desktop.agentContact.addEventListener("eAgentConsulting", (e => this.logEvent(e, "eAgentConsulting"))), e.Desktop.agentContact.addEventListener("eAgentConsultFailed", (e => this.logEvent(e, "eAgentConsultFailed"))), e.Desktop.agentContact.addEventListener("eAgentConsultEndFailed", (e => this.logEvent(e, "eAgentConsultEndFailed"))), e.Desktop.agentContact.addEventListener("eAgentConsultConferenceEndFailed", (e => this.logEvent(e, "eAgentConsultConferenceEndFailed"))), e.Desktop.agentContact.addEventListener("eParticipantLeftConference", (e => this.logEvent(e, "eParticipantLeftConference"))), e.Desktop.agentContact.addEventListener("eParticipantJoinedConference", (e => this.logEvent(e, "eParticipantJoinedConference"))), e.Desktop.agentContact.addEventListener("eContactUpdated", (e => this.logEvent(e, "eContactUpdated")))
            }
            async logEvent(e, n) {
                t.debug("Start logEvent"), t.debug(`************** LOGGING EVENT - ${n} ****************`), t.debug(e);
                let i = await this.getCallStateFromEvent(e);
                "terminated" === i && (i = await this.getCallState()), t.debug("Updating Buttons"), await this.updateButtons(i), t.debug("*********************************************")
            }
            removeListeners() {
                t.info("Removing WebexCC Event Listeners"), e.Desktop.agentContact.removeAllEventListeners()
            }
            async getCallState() {
                const e = this.details,
                    n = await this.getInteractionId();
                t.debug(`Getting Call State for interaction id ${n}`);
                let i = "unknown",
                    r = "unknown";
                for (const [o, s] of Object.entries(e.toJSON()))
                    if (t.debug("getCallState - Dumping Interaction Data for interaction_id " + o), t.debug(s), o === n) {
                        t.debug(`Found Interaction Data for id ${n}`);
                        const e = s.interaction.owner;
                        switch (t.debug(`interaction_owner is ${e}`), i = !0 === s.interaction.isTerminated ? "terminated" : null === e ? "wrapup" : s.interaction.state, r = s.type, t.debug("interaction_type = " + r), r) {
                            case "AgentConsultCreated":
                            case "AgentConsulting":
                                i = "consulting";
                                break;
                            case "AgentConsultConferenced":
                                "consultInitiated" === s.interaction.participants[e].consultState && (i = "consulting");
                                break;
                            case "AgentWrapup":
                                i = "wrapup"
                        }
                    } return t.debug(`*********** Returning call_state: ${i}`), i
            }
            async getCallStateFromEvent(e) {
                const n = await this.getInteractionId(),
                    i = this.agent_id,
                    r = this.selected_task;
                t.debug("call_interaction_id = " + n), t.debug("agent id = " + i), t.debug("selected task dump:"), t.debug(r);
                let o = "unknown";
                if (void 0 === n) t.debug("Getting Call State From Event - No call interaction id found - returning unknown");
                else {
                    t.debug(`Getting Call State From Event for interaction id ${n}`);
                    let i = "unknown";
                    t.debug("getCallStateFromEvent - Dumping Interaction Data for interaction_id " + n);
                    let r = e.data.interaction;
                    t.debug(r);
                    const s = r.owner;
                    switch (t.debug(`interaction_owner is ${s}`), t.debug(`isTerminated = ${r.isTerminated}`), t.debug(`state = ${r.state}`), t.debug("relationshipType = " + r.callProcessingDetails.relationshipType), o = !0 === r.isTerminated ? "terminated" : null === s ? "wrapup" : r.state, t.debug("provisional call state = " + o), i = e.data.type, t.debug("interaction_type = " + i), i) {
                        case "AgentConsultCreated":
                        case "AgentConsulting":
                            o = "consulting";
                            break;
                    ...
                    for (const [e, n] of Object.entries(r.participants)) t.debug("participant id = " + e), t.debug("consultState = " + n.consultState), t.debug("participant_data = " + n), !1 === n.hasLeft && !1 === n.isWrapUp && (t.debug("participant is still in call"), "consulting" !== n.consultState && "consultInitiated" !== n.consultState || (t.debug("participant is consulting"), o = "consulting"));
                    "connected" === r.state && "consult" === r.callProcessingDetails.relationshipType && "Consult_Transfer_To_EpDn" !== e.data.reason && (o = "consulting")
                }
                return t.debug(`*********** Returning call_state: ${o}`), o
            }
            getEmptyButtonMap() {
                return {
                    button1: {
            ...
            async consultToDN(n) {
                t.debug("consultToDN started");
                let i = !0;
                try {
                    i = this.holdParticipants
                } catch (e) {
                    t.error("Error getting holdParticipants from config, defaulting to true.")
                }
                i = !0, t.debug("Hold Participants Setting: " + i);
                ...
                return t.debug("consultToDN response: " + JSON.stringify(o)), o
            }
            async processButtonPress(e, n) {
                switch (t.debug(`Sending button click event for button ${e} with payload ${n}`), t.debug(`button name: ${e}, payload = ${n}`), e) {
                    case "button1":
                    case "button2":
                    case "button3":
                        let i = Date.now(),
                            r = i - this.lastButtonPressTime;
                        if (this.lastButtonPressTime = i, r > 5e3) {
                            t.debug(`Processing button press (${e}) - ${r}ms since last button press.`);
                            let i = await this.consultToDN(n);
                            t.debug(i)
                        } else t.error(`Ignoring button press (${e}) - only ${r}ms since last button press.`)
                }
            }
            showConsultModal() {
        ...
        window.customElements.define("conference-control-ui", i)
    })()
})();
